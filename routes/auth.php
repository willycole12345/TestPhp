...
Route::middleware('guest')->group(function () {
    ...
    Route::get('otp/{otpCode}/{email}', [AuthenticatedSessionController::class, 'otp'])
    ->name('otp');


    Route::get('googlelogin/{driver}', [AuthenticatedSessionController::class, 'googleredirect'])
                ->name('googlelogin');

    Route::get('{driver}/storegoogleusers', [AuthenticatedSessionController::class, 'storegoogleusers']);
